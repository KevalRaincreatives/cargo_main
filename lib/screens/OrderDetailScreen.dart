...
class OrderDetailScreen extends StatefulWidget with WidgetsBindingObserver{
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      child: DeliveryMode(order_model.details.deliveryMethod),
                    ),
                    SizedBox(
                      height: 16,
                    ),
...
//            String base64Image = base64Encode(bytes);
  ...
  void _requestDownload(index) async {
    order_model.details.invoices[index].taskId =await FlutterDownloader.enqueue(
        url: order_model.details.invoices[index].invoice,
...
//  }
  ...
  Future<bool> _openDownloadedFile(index) {
    return FlutterDownloader.open(taskId: order_model.details.invoices[index].taskId);
  }
